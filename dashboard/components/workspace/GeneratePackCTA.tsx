...
export function GeneratePackCTA() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 lg:left-64 bg-white border-t border-gray-200 shadow-lg z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              href={`/api/ideas/${idea.id}/export/pdf`}
              download
              ...
              title="Download idea summary as PDF"
            >
              <svg
                aria-hidden="true"
                className="w-4 h-4"
